...
export default function Leave_home(props){
    ...
    function render(s){
        ...
        return(
        <LongBox heading={subject} lg colors={gradient} text={`${status.toUpperCase()} | Date: ${date}`} fun={()=>{navigation.navigate('application',{data:item,deleteFun:handleDelete})}} icon="document-outline"/>
        )
    }
